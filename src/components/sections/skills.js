...
`;
const StyledSkillCategory = styled.h4`
  color: ${colors.lightestSlate};
  font-size: ${fontSizes.xxl};
  font-weight: 500;
  margin-bottom: 5px;
`;
const StyledSkillDetails = styled.h5`
  font-family: ${fonts.SFMono};
  font-size: ${fontSizes.smish};
  font-weight: normal;
    ...
    <StyledContainer id="skills" ref={revealContainer}>
      ...
      <StyledTabs>
        ...
        {skillGroups.map(({ name, description }, i) => {
          let skillsArray = [];
          try {
            // Parse description as JSON array if it’s a stringified array
